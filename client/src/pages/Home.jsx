...
function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Most repairs completed within 1-3 hours. We know your phone is essential.",
    },
    {
      icon: "🛡️",
      title: "6-Month Warranty",
      desc: "Every repair comes with a 6-month warranty on parts and labor. No surprises.",
    },
    {
      icon: "💰",
      title: "Transparent Pricing",
      desc: "No hidden charges. Get an upfront quote before we start any work.",
    },
  ];
    ...
    <div>
      ...
      <section
        className="relative min-h-screen flex items-center pt-20 overflow-hidden
                          ...
                          dark:from-navy dark:via-navy dark:to-navy-light"
      >
        <div
        ...
        />
        <div className="max-w-6xl mx-auto px-6 py-20 animate-[fadeInUp_0.8s_ease_forwards]">
          ...
          <p className="text-lg text-slate-500 dark:text-slate-400 max-w-xl mb-10 leading-relaxed">
            ...
            water damage, software — we fix it all with a 6-month warranty.
          </p>
          ...
          <div className="flex flex-wrap gap-6 text-sm text-slate-500 dark:text-slate-400 font-medium">
            {["✓ OEM Parts", "✓ 6-Month Warranty", "✓ No Fix, No Fee"].map(
              (t) => (
                <span key={t}>{t}</span>
              ),
            )}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((f, i) => (
              <div
                key={i}
                className="text-center p-8 rounded-2xl bg-white dark:bg-navy
