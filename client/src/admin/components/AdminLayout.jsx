...
const navItems = [
  ...
  { to: "/admin/feedback", label: "Reviews", icon: "⭐", end: false },
];
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white dark:bg-navy-light border-b border-slate-200 dark:border-white/[0.06] flex items-center justify-between px-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center font-display font-bold text-white text-sm">
              {user?.name?.charAt(0)}
            </div>
          </div>
        </header>
